...
import {data} from "../data/ibbUploader.data";
        ...
        >
          ...
          transition={{ duration: 0.7 }}>
            ...
            transition={{ duration: 1 }}>
                <a href="https://github.com/dlrodev92/ibb_uploader_python" target="_blank"><img src="https://i.ibb.co/zhD6KVZ/Untitled-design-20.png" alt="github" className="w-[125px] h-[125px]  p-5 hover:scale-110  duration-500 cursor-pointer " /></a>
                <a href="https://github.com/dlrodev92/IbbUploader_nodejs" target="_blank"><img src="https://i.ibb.co/zhD6KVZ/Untitled-design-20.png" alt="github" className="w-[125px] h-[125px]  p-5 hover:scale-110  duration-500 cursor-pointer " /></a>
            </motion.div>
            </motion.div>
          </motion.div>
        </motion.div>
